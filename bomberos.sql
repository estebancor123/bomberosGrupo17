...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2023 a las 04:19:26
...
(5, 'Esteban ', '1980-04-25', 2, 11111, 12454, 1, 'Cornejo', 'o-'),
...
(18, 'asdas', '2023-10-05', 1, 1112312, 123123, 1, 'asda', 'a'),
(19, 'Cordoba', '1980-04-25', 1, 7777, 5555, 1, 'Martinez', 'a+');
...
(1, 'sin asignar', 'sin asignar', 1, 2, 1),
...
(1, 'incendios', '2023-10-15', 12, 15, 'se que el rancho', '2023-10-16', 8, 4),
...
(7, 'incendios', '2023-10-16', 12, 12, 'asdasd', '0000-00-00', 0, 1);
...
--
ALTER TABLE `bombero`
  MODIFY `id_bombrero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
